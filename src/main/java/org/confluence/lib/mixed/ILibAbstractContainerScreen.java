...
public interface ILibAbstractContainerScreen {
    ...
    Identifier TAB_ITEMS = ConfluenceMagicLib.asResource("creative_inventory_tab_items");

    static void renderGroupBackground(GuiGraphicsExtractor instance, ItemStack stack, int x, int y, Slot slot) {
