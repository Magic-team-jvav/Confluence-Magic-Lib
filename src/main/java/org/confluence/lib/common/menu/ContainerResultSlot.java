...
import org.confluence.lib.common.recipe.IRecipeWithIngredients;
import org.jetbrains.annotations.Nullable;

public class ContainerResultSlot extends Slot {
    protected @Nullable IRecipeWithIngredients<?> recipe;

    public ContainerResultSlot(Container container, int slot, int x, int y) {
        super(container, slot, x, y);
    }

    public void setCurrentRecipe(@Nullable IRecipeWithIngredients<?> recipe) {
        this.recipe = recipe;
    }
