...
public class FluidBuilder {
    static final Hashtable<Identifier, FluidBuilder> BUILDERS = new Hashtable<>();
    ...
    private Consumer<FluidType.Properties> typePropertiesConsumer = _ -> {};
    private Consumer<BaseFlowingFluid.Properties> basePropertiesConsumer = _ -> {};

    FluidBuilder(Identifier location) {
        this.type = DeferredHolder.create(NeoForgeRegistries.Keys.FLUID_TYPES.identifier(), location);
