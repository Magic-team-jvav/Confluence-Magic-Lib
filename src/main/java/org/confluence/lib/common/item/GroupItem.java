...
public class GroupItem extends Item {
    ...
    @ApiStatus.Internal
    public GroupItem(Identifier identifier) {
    ...
    public static ItemStack of(Identifier name, ItemStack... stacks) {
        return of(name, Arrays.asList(stacks));
    }

    public static ItemStack of(Identifier name, List<ItemStack> stacks) {
    ...
    public static class Stacks implements DataComponentType<Stacks> {
        ...
        public static final Codec<Stacks> CODEC = MapCodec.unitCodec(EMPTY);
        ...
        private transient final Identifier name;
        private transient final boolean visible;
        private transient final ItemStack[] values;
        private transient final int id;

        private Stacks(Identifier name, boolean visible, ItemStack[] values, int id) {
            this.name = name;
        ...
        public static Stacks of(Identifier name, boolean visible, ItemStack... stacks) {
            return of(name, visible, Arrays.asList(stacks));
        }

        public static Stacks of(Identifier name, boolean visible, List<ItemStack> stacks) {
    ...
    public record BelongsTo(Identifier name) implements DataComponentType<BelongsTo> {
        public static final Codec<BelongsTo> CODEC = Identifier.CODEC.xmap(BelongsTo::new, BelongsTo::name);
        public static final StreamCodec<ByteBuf, BelongsTo> STREAM_CODEC = Identifier.STREAM_CODEC.map(BelongsTo::new, BelongsTo::name);
        ...
        public boolean equals(Object o) {
            return o == this || (o instanceof BelongsTo(Identifier rl) && rl.equals(name));
        }
