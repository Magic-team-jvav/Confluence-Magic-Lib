...
public class IdFixer {
    ...
    private static final Map<String, String> BLOCK_WITH_ITEM_NAME_FIX_MAP = ImmutableMap.<String, String>builder()
            ...
            .put("confluence:tr_emerald_ore", "confluence:pure_emerald_ore")
            .put("confluence:deepslate_tr_emerald_ore", "confluence:deepslate_pure_emerald_ore")
            .put("confluence:sanctification_tr_emerald_ore", "confluence:sanctification_pure_emerald_ore")
            ...
            .put("confluence:tr_amethyst_ore", "confluence:pure_amethyst_ore")
            .put("confluence:deepslate_tr_amethyst_ore", "confluence:deepslate_pure_amethyst_ore")
            .put("confluence:sanctification_tr_amethyst_ore", "confluence:sanctification_pure_amethyst_ore")
            .put("confluence:corruption_tr_amethyst_ore", "confluence:corruption_pure_amethyst_ore")
            .put("confluence:fleshification_tr_amethyst_ore", "confluence:fleshification_pure_amethyst_ore")
    ...
    private static final Map<String, String> ITEM_NAME_FIX_MAP = ImmutableMap.<String, String>builder()
            ...
            .put("confluence:tr_amethyst", "confluence:pure_amethyst")
