...
public final class LibTags {
    public static class Items {
        ...
        private static TagKey<Item> common(String id) {
            return ItemTags.create(Identifier.fromNamespaceAndPath("c", id));
        }
    }
    ...
    public static class MobEffects {
        public static final TagKey<MobEffect> DENY_HEAL = register("deny_heal");

        private static TagKey<MobEffect> register(String id) {
            return TagKey.create(Registries.MOB_EFFECT, ConfluenceMagicLib.asResource(id));
        }
    }
