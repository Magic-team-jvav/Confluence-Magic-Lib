...
public final class ConfluenceMagicLib {
    ...
    public ConfluenceMagicLib(IEventBus eventBus, ModContainer container) {
        ...
        ATTACHMENT_TYPE.register(eventBus);
        {
            ...
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "generic.crit_chance"), CRITICAL_CHANCE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "generic.ranged_velocity"), RANGED_VELOCITY.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "generic.ranged_damage"), RANGED_DAMAGE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "generic.dodge_chance"), DODGE_CHANCE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "generic.magic_damage"), MAGIC_DAMAGE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "generic.armor_penetration"), ARMOR_PENETRATION.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "player.pickup_range"), PICKUP_RANGE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_curio", "player.aggro"), AGGRO.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_entity", "player.minion_capacity"), MINION_CAPACITY.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_entity", "player.sentry_capacity"), SENTRY_CAPACITY.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_entity", "player.summon_damage"), SUMMON_DAMAGE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_entity", "player.summon_knockback"), SUMMON_KNOCKBACK.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_entity", "player.whip_range"), WHIP_RANGE.getId());
            ATTRIBUTES.addAlias(Identifier.fromNamespaceAndPath("terra_entity", "player.mark_damage"), MARK_DAMAGE.getId());
        }
    ...
    public static Identifier asResource(String path) {
        return Identifier.fromNamespaceAndPath(LIB_ID, path);
    }

    public static Identifier asConfluenceResource(String path) {
        return Identifier.fromNamespaceAndPath(CONFLUENCE_ID, path);
    }
}
