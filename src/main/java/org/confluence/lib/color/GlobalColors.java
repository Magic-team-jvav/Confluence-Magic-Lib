...
public class GlobalColors {
    ...
    public static final IntegerRGB EVENT = IntegerRGB.of(0xaf4bff);
    public static final IntegerRGB PARTY = IntegerRGB.of(0xff00a0);
    public static final IntegerRGB TIPS = IntegerRGB.of(0xfff014);
}
